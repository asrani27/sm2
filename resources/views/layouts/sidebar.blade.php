...
<section class="sidebar">
    ...
    <li class="{{ (request()->is('kecamatan')) ? 'active' : '' }}"><a href="/kecamatan"><i class="fa fa-home"></i> <span>Beranda</span></a></li>
    <li><a href="/logout"><i class="fa fa-sign-out"></i> <span>Logout</span></a></li>
    
    @elseif(Auth::user()->hasRole('kelurahan'))
    <li class="{{ (request()->is('kelurahan')) ? 'active' : '' }}"><a href="/kelurahan"><i class="fa fa-home"></i> <span>Beranda</span></a></li>
    <li><a href="/logout"><i class="fa fa-sign-out"></i> <span>Logout</span></a></li>
