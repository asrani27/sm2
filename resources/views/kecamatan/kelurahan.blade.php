    ...
    <div class="col-md-12">
        <div class="box box-primary">
            <div class="box-header">
                ...
                <h3 class="box-title">List TPS {{$kelurahan->nama}}</h3>
            </div>
            <!-- /.box-header -->
            <form class="form-horizontal" method="post" action="/kecamatan/tps/suara">
                @csrf
                    ...
                    <table class="table table-hover">
                        <tbody>
                            ...
                            <td>
                                ...
                                <a href="/kecamatan/kelurahan/{{$kelurahan->id}}/edittps/{{$item->id}}" class="btn btn-flat btn-xs btn-primary"><i class="fa fa-edit"></i></a>
                            </td>
                            <td>{{$item->tps}}</td>
                            <td>{{$item->nomor_1}}</td>
                            <td>{{$item->nomor_2}}</td>
