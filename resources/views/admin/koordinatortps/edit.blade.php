...
<div class="row">
    <div class="col-md-12">
        <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <form class="form-horizontal" method="post" action="/superadmin/koordinatortps/edit/{{$data->id}}">
                @csrf
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="tps" value="{{$data->tps}}"  required>
                        </div>
                    </div>
                    <div class="form-group">
