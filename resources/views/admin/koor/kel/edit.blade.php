...
<div class="row">
    <div class="col-md-12">
        <a href="/superadmin/koordinator/kelurahan" class="btn btn-flat btn-primary"><i class="fa fa-backward"></i> Kembali</a> <br /><br />
    </div>
</div>
...
<div class="row">
    <div class="col-md-12">
        <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <form class="form-horizontal" method="post" action="/superadmin/koordinator/kelurahan/edit/{{$data->id}}">
                @csrf
                <div class="box-body">
