...
<head>
    ...
    <title>Profile Sahabat Mukhyar</title>

    <!-- Global stylesheets -->
    <link href="/profile/css/bootstrap/bootstrap.min.css" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css?family=Saira+Extra+Condensed:100,200,300,400,500,600,700,800,900" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,300i,400,400i,600,600i,700,700i,800,800i" rel="stylesheet">
    <link href="/profile/font-awesome/css/font-awesome.min.css" rel="stylesheet">
    <link href="/profile/css/devicons/css/devicons.min.css" rel="stylesheet">
    <link href="/profile/css/simple-line-icons/css/simple-line-icons.css" rel="stylesheet">
...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
      <a class="navbar-brand js-scroll-trigger" href="#page-top">
        ...
        <span class="d-none d-lg-block">
          <img class="img-fluid img-profile rounded-circle mx-auto mb-2" src="/profile/img/profile-pic.jpg" alt="">
        </span>
      </a>
    ...
    ======================================================-->
      <section class="resume-section p-3 p-lg-5 d-flex d-column" id="about">
          <div class="my-auto" >
              <img src="/profile/img/logo-s.png" class="img-fluid mb-3" alt="">
              <h1 class="mb-0">Sahabat
                <span class="text-primary">Mukhyar</span>
              </h1>
              <div class="subheading mb-5">THE NEXT 2024 -
                  <a href="#">SIAPA YANG PIAN TUNGGU 2024?</a>
              </div>
...
======================================================-->
    ...
    <script src="/profile/js/bootstrap/bootstrap.bundle.min.js"></script>
    <script src="/profile/js/jquery-easing/jquery.easing.min.js"></script>
    <script src="/profile/js/counter/jquery.waypoints.min.js"></script>
    <script src="/profile/js/counter/jquery.counterup.min.js"></script>
