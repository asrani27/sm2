...
<hr>
<div class="row">
  <form method="get" action="/petugas/laporan/perkelurahan" target="_blank">
    @csrf
    <div class="col-lg-3">
...
<hr>
<div class="row">
  <form method="get" action="/petugas/laporan/perpetugas" target="_blank">
    @csrf
...
<hr>
<div class="row">
  <form method="get" action="/petugas/laporan/filter">
    @csrf
    <div class="col-lg-3">
    ...
    <div class="col-md-12">
        <div class="box">
          <div class="box-header">
            ...
            {{-- <div class="box-tools">
              <form class="form" method="get" action="/petugas/dpt/cari">
